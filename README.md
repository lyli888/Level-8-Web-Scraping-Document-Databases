...
### NOTE: This is a back-end application that collects data from web pages, stores the information in a MongoDB database, & then updates/publishes to a web page. Refer to ["screenshots of scrape function" folder](/Screenshots_of_Scrape_Function/) for project results. 
